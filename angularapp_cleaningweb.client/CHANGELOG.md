...
- Create Angular project with ng: `ng new angularapp_cleaningweb.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularapp_cleaningweb.client.esproj`).
